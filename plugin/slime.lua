...
function IPythonOpen()
  ...
  vim.keymap.set("n", "<C-c><C-c>", ":lua IPythonSendCell()<CR>") -- cell
  vim.keymap.set("n", "<C-c><C-p>", ":lua IPythonSendParagraph()<CR>") -- paragraph
  vim.keymap.set("n", "<C-c><C-l>", ":lua IPythonSendLine()<CR>") -- current line
